 ...
 * @author Raman
 */
public class modifylacc extends JFrame implements ActionListener,ItemListener
{
    Choice c1,c2;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String q="Update loan set CustName='"+t1.getText()+"',LoanAm="+t2.getText()+",StartDate='"+t3.getText()+"',NoOfMonths="+t4.getText()+",ROI="+t5.getText()+",EMI="+t6.getText()+",LoanType='"+t7.getText()+"',Status='"+t8.getText()+"' where LoanId="+c2.getSelectedItem();
